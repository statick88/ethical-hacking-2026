...
- **Shodan**: Dispositivos IoT y servidores
- **Censys**: Certificados y fingerprints

**Google Dorks (Busquedas Avanzadas)**
...
python theHarvester.py -d empresa.com -b google,bing,linkedin -s -v -n
```
...
workspaces create pentest_ empresa
...
|-------------|-----------|-------------------|
| **Nmap** | Escaneo de red y puertos | `sudo apt install nmap` o nmap.org |
| **Recon-ng** | Framework de reconocimiento web | `pip install recon-ng` |
| **SpiderFoot** | Automatización OSINT | spiderfoot.net |
| **theHarvester** | Recopilación de emails/subdominios | `git clone theHarvester` |
| **Maltego CE** | Análisis visual de enlaces | maltego.com |
| **Shodan CLI** | Busqueda de dispositivos | `pip install shodan` |
...
**Escenario**: Realizar reconocimiento completo de un objetivo simulado (máquina TryHackMe o Docker con servicios expuestos). El estudiante debe identificar:
...
- [SpiderFoot Documentation](https://spiderfoot.net/documentation/)
- [TryHackMe: Intro to Reconnaissance](https://tryhackme.com/room/reconlearn)
