...
## 🗺️ Ruta de Certificación HTB Academy (HCAIRT)

Esta unidad cubre el 40% de los objetivos de la certificación **HTB Certified AI Red Teamer**. Se recomienda completar los siguientes módulos en la plataforma:

1. **Prompt Injection Attacks**: Técnicas avanzadas de bypass.
2. **LLM Output Attacks**: Explotación de handlers de salida.
3. **AI Privacy**: Técnicas de extracción de datos de entrenamiento.
4. **AI Defense**: Aplicación del framework Google SAIF.