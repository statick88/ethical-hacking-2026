...
CONTAINERS=(ethical-hacking-kali target-llm-api target-gandalf)
...
echo "  localhost:5000 (API LLM), localhost:5001 (Gandalf)"

# 6. Verificación final
echo ""
echo -e "${BLUE}=== Paso 6: Verificación final ===${NC}"
echo -e "${GREEN}[OK]${NC} lab2 iniciado correctamente"
