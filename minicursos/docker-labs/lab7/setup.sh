...
CONTAINERS=(lab7-openplc lab7-hmi lab7-kali)
...
echo "  localhost:8080 (OpenPLC), localhost:9090 (HMI)"

# 6. Verificación final
echo ""
echo -e "${BLUE}=== Paso 6: Verificación final ===${NC}"
echo -e "${GREEN}[OK]${NC} lab7 iniciado correctamente"
