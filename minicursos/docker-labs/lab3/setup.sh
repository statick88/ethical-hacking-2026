...
CONTAINERS=(lab3-dvwa lab3-db lab3-juice-shop lab3-vapi lab3-kali)
...
echo "  localhost:8080 (DVWA), localhost:3000 (Juice Shop)"

# 6. Verificación final
echo ""
echo -e "${BLUE}=== Paso 6: Verificación final ===${NC}"
echo -e "${GREEN}[OK]${NC} lab3 iniciado correctamente"
