...
CONTAINERS=(lab1-kali lab1-metasploitable)
...
echo "  172.18.1.10 (Kali), 172.18.1.20 (Metasploitable)"

# 6. Verificación final
echo ""
echo -e "${BLUE}=== Paso 6: Verificación final ===${NC}"
echo -e "${GREEN}[OK]${NC} lab1 iniciado correctamente"
