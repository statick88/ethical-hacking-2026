...
CONTAINERS=(lab4-dc01 lab4-member01 lab4-kali)
...
echo "  192.168.56.101 (Kali), 192.168.56.102 (DC01)"

# 6. Verificación final
echo ""
echo -e "${BLUE}=== Paso 6: Verificación final ===${NC}"
echo -e "${GREEN}[OK]${NC} lab4 iniciado correctamente"
